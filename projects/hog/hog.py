...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    num_1 = abs(player_score%10-opponent_score%10)
    num_2 = 0
    opponent_score = str(opponent_score)
    if len(opponent_score) >= 2:
        num_2 = int(opponent_score[-2])
    if (num_1 == num_2):
        return True
    return False
    ...
    if feral_hogs == True:
        ...
        while(score0<goal and score1 <goal):
            if who == 0:
                ...
                if abs(got_0-roll_number) == 2:
                    score0 += 3
                got_0 = take_turn(roll_number,score1,dice)
                score0 += got_0
            ...
            if who == 1:
                ...
                if abs(got_1 - roll_number) == 2:
                    score1 += 3
                got_1 = take_turn(roll_number, score0, dice)
                score1 += got_1
    ...
    def say(score0, score1):
        if who == 0:
            ...
            if gain > running_high:
                print("%d point(s)! That's the biggest gain yet for Player 0" % gain)
        ...
        if who == 1:
            ...
            if gain > running_high:
                print("%d point(s)! That's the biggest gain yet for Player 1" % gain)
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    add = 10-opponent_score%10+opponent_score//10%10
    if is_swap(score+add,opponent_score):
        if score + add < opponent_score:
            return 0
        elif score + add > opponent_score:
            return num_rolls
    if add >= cutoff:
        return 0;
    return num_rolls
